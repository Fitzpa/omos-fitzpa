...
- Use targeted CodeGraph codegraph_impact, codegraph_callers, and
  codegraph_callees exploration when available and relevant to architecture,
  debugging, review, or simplification questions
